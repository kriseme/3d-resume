...
export const resume: ResumeData = {
  ...
  summary:
    '电气工程硕士在读，专业排名 1/30（GPA 3.82）；熟悉需求分析、方案设计、原理图/PCB 设计、样机测试到现场验证的完整研发流程；参与多项国网科技项目并驻地实践，持有实用型专利 1 项、软件著作权 3 项。',
  contact: {
  ...
  activities: [
    ...
    {
      period: '2024.09 — 至今',
      title: '中国农业大学信息与电气工程学院硕士 2409 班',
      subtitle: '班长',
      description: '负责班级事务与信息传达。',
    },
    {
  ...
  honors: [
    ...
    { name: '实用型新兴专利 1 项、软件著作权 3 项', year: '在读期间' },
  ],
};
